...
const criarIndicacaoSchema = z.object({
  ...
  empresaContato: stringMinMaxSchema(2, 100, 'Empresa/Contato'),
  descricao: textoLongoSchema(10, 1000, 'Descrição'),
  valorEstimado: valorMonetarioSchema(1000, 10000000).optional(),
  observacoes: textoLongoSchema(0, 500, 'Observações').optional(),
});
