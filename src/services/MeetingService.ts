...
const criarMeetingSchema = z.object({
  membro1Id: objectIdSchema,
  membro2Id: objectIdSchema,
  dataReuniao: dataSchema,
  local: stringMinMaxSchema(0, 200, 'Local').optional(),
  observacoes: textoLongoSchema(0, 1000, 'Observações').optional(),
});
...
const atualizarMeetingSchema = z.object({
  dataReuniao: dataSchema.optional(),
  local: stringMinMaxSchema(0, 200, 'Local').optional(),
  observacoes: textoLongoSchema(0, 1000, 'Observações').optional(),
});
